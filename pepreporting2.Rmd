...
.center[
<https://tbep-tech.github.io/pepreporting/articles/pathogens.html>
]
...
.center[
<https://tbep-tech.github.io/pepreporting/articles/dissolvedoxygen.html>
]
...
* Gets the following for each month:
   ...
   1. Mean daily DO
   1. Proportion of days with low DO (magnitude)
   1. max run of days with low DO (duration)
