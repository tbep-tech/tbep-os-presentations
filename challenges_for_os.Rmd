...
### - Invest in your health: change is not easy but investments will have returns
...
### - Open processes and open data can invite additional criticism

### - But this is absolutely critical for applied science!
...
### - Anonymize the data! Tools in the `tidyverse` can help, e.g., generalize locations, randomize identifiers...
