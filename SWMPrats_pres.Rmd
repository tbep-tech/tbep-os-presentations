...
#### SWMPr addresses the unglamorous but necessary challenges of analyzing water quality monitoring data
...
```{r, fig.width = 8, fig.height = 2.5, out.width = "80%", echo = F}
...
```{r, fig.width = 8, fig.height = 2.5, echo = F, out.width = "80%"}
par(mar = c(4, 4, 0.1, 0.1))
# import, organize
data(apadbwq)
dat <- qaqc(apadbwq)
