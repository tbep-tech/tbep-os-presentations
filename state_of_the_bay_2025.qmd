...
* turbidity, color in OTB

* nanoplankton in OTB

* benthic data - percent silt/clay/etc in OTB
...
::: {.notes}
Emphasize only two locations exceeding.
:::
...
p1 <- show_boxplot(epcdata, bay_segment = "OTB", param = "la", yrrng = yrrng, yrsel = maxyr, partialyr = partialyr) + scly
p2 <- show_boxplot(epcdata, bay_segment = "HB", param = "la", yrrng = yrrng, yrsel = maxyr, partialyr = partialyr) + scly
p3 <- show_boxplot(epcdata, bay_segment = "MTB", param = "la", yrrng = yrrng, yrsel = maxyr, partialyr = partialyr) + scly
p4 <- show_boxplot(epcdata, bay_segment = "LTB",  param = "la", yrrng = yrrng, yrsel = maxyr, partialyr = partialyr) + scly
...
::: {.notes}
Supplementary analysis that comes with a lot of caveats and also note that SSOs are not the sole driver of water quality but important to consider.
:::
...
::: {.notes}
Note single issue, spill all contained on-site.  Possibly related to illicit discharge upstream?
:::
...
* All segments provisionally meet chlorophyll and light attenuation management target except HB, LTB also exceeded light penetration target pushing it to "Caution"
