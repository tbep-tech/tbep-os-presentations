...
::: {.columns style="display: flex !important; height: 10%;"}
::: {.column width="90%" style="display: flex; justify-content: center; align-items: top;"}
Oyster bars, forested freshwater wetlands, coastal uplands
:::
:::
...
::: {.column width="90" style="display: flex; justify-content: center; align-items: top;"}
![](figure/ianoyster.png){style="margin-bottom: 2rem;"}
![](figure/ianwetland.png){style="margin-bottom: 2rem;"}
